...
func (s *Service) profileToAPI(p data.SpeakerProfile) notoapi.SpeakerProfile {
...
func (s *Service) profilesToAPI(profiles []data.SpeakerProfile) []notoapi.SpeakerProfile {
...
func (s *Service) mappingToAPI(m data.MeetingSpeakerMapping) notoapi.MeetingSpeakerMapping {
...
func (s *Service) mappingsToAPI(mappings []data.MeetingSpeakerMapping) []notoapi.MeetingSpeakerMapping {
