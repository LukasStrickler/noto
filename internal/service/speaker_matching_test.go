...
func (f *fakeSpeakerProfileRepo) Create(ctx context.Context, p data.SpeakerProfile) error {
	f.profiles = append(f.profiles, p)
	return nil
}
func (f *fakeSpeakerProfileRepo) Get(ctx context.Context, id string) (data.SpeakerProfile, error) {
...
func (f *fakeSpeakerProfileRepo) List(ctx context.Context) ([]data.SpeakerProfile, error) {
	return f.profiles, nil
}
func (f *fakeSpeakerProfileRepo) Update(ctx context.Context, p data.SpeakerProfile) error {
...
func (f *fakeMeetingMappingRepo) Upsert(ctx context.Context, m data.MeetingSpeakerMapping) error {
...
func (f *fakeMeetingMappingRepo) ListByMeeting(ctx context.Context, meetingID string) ([]data.MeetingSpeakerMapping, error) {
	var result []data.MeetingSpeakerMapping
...
func (f *fakeMeetingMappingRepo) DeleteByMeeting(ctx context.Context, meetingID string) error {
	var remaining []data.MeetingSpeakerMapping
	for _, m := range f.mappings {
		if m.MeetingID != meetingID {
...
var _ = data.MeetingSpeakerMapping{}
